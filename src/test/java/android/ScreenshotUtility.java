...
public class ScreenshotUtility implements ITestListener {
    ...
    public void onStart(ITestContext tr) {
        //duplikat dosyalari engellemek icin
        FileSystemUtils.deleteRecursively(new File("screenshots"));
    ...
    public void captureScreenShot(ITestResult result, String status) {
        ...
        File scrFile = ((TakesScreenshot) AppDriver.getDriver()).getScreenshotAs(OutputType.FILE);
